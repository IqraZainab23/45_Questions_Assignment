...
let name1: string = "Rida\tNaz";
let name2: string = "Rida\nNaz";
console.log(name1);
console.log(name2)
;
console.log("----x----".repeat(7))     // for visual clarity
...
let names: string[] = ["Huda", "Sabeen", "Hafsa", "Tasbiha"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
let vehicles: string[] = ["BMW i5", "Honda Motorcycle", "Audi A1"];
...
let guests: string[] = ["Shyla", "Arshi", "Mehnaz"];
...
let canNotAttend: string = "Mehnaz";
...
let beginningGuest: string = "Erum";
guests[guests.unshift(beginningGuest)];

let middleGuest: string = "Rabia";
...
let countriesArray: string[] = ["Pakistan", "France", "Turkey", "Switzerland", "America"];
...
let userName: string[] = ["Admin", "Rida", "Naeem"];
